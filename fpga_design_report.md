...
- **Interfaces**: Register Bus (16-bit), SPI Master (4 CS), ADC Data (8-bit LVDS), UART Debug, GPIO (8-bit), DAC (8-bit)
...
| `rtl/constraints.xdc` | Vivado timing constraints for 12 MHz |
