...
- **Interfaces**: Register Bus (16-bit), SPI Master (4 CS), UART Debug, GPIO (8-bit)
...
| File | Description |
|------|-------------|
| `rtl/fpga_top.v` | Top module with 2 FSMs, 14 registers, 19 ports |
| `rtl/fpga_testbench.v` | Functional testbench with register R/W and FSM tests |
| `rtl/constraints.xdc` | Vivado timing constraints for 100 MHz |
