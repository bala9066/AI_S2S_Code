...
- **Interfaces**: Register Bus (16-bit), SPI Master (4 CS), ADC Data (32-bit LVDS), UART Debug, GPIO (8-bit), DAC (32-bit)
...
| `rtl/constraints.xdc` | Vivado timing constraints for 1000 MHz |
