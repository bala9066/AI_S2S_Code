...
- **Interfaces**: Register Bus (16-bit), SPI Master (4 CS), ADC Data (16-bit LVDS), UART Debug, GPIO (8-bit), DAC (16-bit)
...
| `rtl/constraints.xdc` | Vivado timing constraints for 125 MHz |
