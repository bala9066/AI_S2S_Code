...
- **Interfaces**: Register Bus (16-bit), SPI Master (4 CS), ADC Data (14-bit LVDS), UART Debug, GPIO (8-bit), DAC (14-bit)
...
| `rtl/constraints.xdc` | Vivado timing constraints for 52 MHz |
