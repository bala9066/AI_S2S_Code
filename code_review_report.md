...
| `hal_read_or` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_or` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_addresses` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_addresses` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_write` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_write` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x6f` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x6f` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x48` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x48` | `hal.c` | 1 | 4 | 1 | ✅ OK |
...
| `hal_read_reg_0x0500` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x0500` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x05ff` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x05ff` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x0600` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x0600` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x06ff` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x06ff` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x0700` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x0700` | `hal.c` | 1 | 4 | 1 | ✅ OK |
...
---
_Analysis performed by Silicon to Software (S2S) v2 using Lizard_
