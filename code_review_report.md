...
| `hal_read_reg_0x1000` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x1000` | `hal.c` | 1 | 4 | 1 | ✅ OK |
...
| `hal_read_reg_0x0b00` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x0b00` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x0b00` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x0b00` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x0bff` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x0bff` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x00` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x00` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_read_reg_0x5801` | `hal.c` | 1 | 4 | 1 | ✅ OK |
| `hal_write_reg_0x5801` | `hal.c` | 1 | 4 | 1 | ✅ OK |
