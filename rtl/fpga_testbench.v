// Testbench : receiver_module_top_tb
// Project   : Receiver Module
`timescale 1ns / 1ps

module receiver_module_top_tb;
    reg         clk = 0;
    reg         rst_n = 0;
    ...
    initial begin
        $dumpfile("receiver_module_tb.vcd"); $dumpvars(0, receiver_module_top_tb);
        ...
        // T4: ADC capture
        adc_data = 8'hABCD; adc_data_valid = 1;
