// ============================================================
// Module  : receiver_module_top
// Project : Receiver Module
// Clock   : 12 MHz (83.333 ns period)
...
module receiver_module_top (
    ...
    // ADC data interface (LVDS deserialized)
    ...
    assign adc_sync   = ctrl_r[1];  // START bit triggers sync
    ...
    always @(posedge clk) begin
        if (!rst_n)
            ...
            case (reg_addr[11:0])
                ...
                12'h010: reg_rdata <= adc_capture_r[15:0];
                12'h011: reg_rdata <= 16'h0000;
    ...
    always @(posedge clk) begin
        if (!rst_n)
            ...
            status_r <= {12'b0, error_flag, adc_done_r, (acq_state_r == S_DONE), busy};
    end
