...
**Validated:** 2026-04-16 23:44:06 — offline YAML syntax check
...
- Job `build-firmware-arm`: 7 step(s) defined
- Job `unit-tests`: `runs-on` = `ubuntu-22.04`
- Job `unit-tests`: 10 step(s) defined
- Job `static-analysis`: `runs-on` = `ubuntu-22.04`
- Job `static-analysis`: 7 step(s) defined
...
| `build-firmware-arm` | `ubuntu-22.04` | 7 |
| `unit-tests` | `ubuntu-22.04` | 10 |
| `static-analysis` | `ubuntu-22.04` | 7 |
